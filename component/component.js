...
var stache = require("../view/stache5/stache5");
var stacheBindings = require("can-stache-bindings");
var Scope = require("../view/scope/scope");
...
var makeDataBinding = require("./make-data-binding");
...
//var ComponentControl = Control.extend({}); //require("./control/control");
...
modernStache.addBindings(stacheBindings);
	...
	// ## Static
	{
			...
			if (Component) {
				...
				if(this.prototype.ViewModel) {
					if(typeof this.prototype.ViewModel === "function") {
						...
						this.ViewModel = CanMap.extend(vmName, {}, this.prototype.ViewModel);
					}
				} else {
					...
					if(protoViewModel) {
						if(typeof protoViewModel === "function") {
							...
							if(canReflect.isObservableLike(protoViewModel) && canReflect.isMapLike(protoViewModel)) {
								...
								this.ViewModel = CanMap.extend(vmName,{},protoViewModel);
							}
						}
					} else {
						this.ViewModel = CanMap.extend(vmName,{},{});
					}
				}
		...
		setup: function(el, componentTagData) {
			...
			if (preventDataBindings) {
				...
				teardownBindings = setupFn(el, componentTagData, function(initialViewModelData) {
					...
					if(viewModelHandler) {
						...
						if (canReflect.isObservableLike(scopeResult) && canReflect.isMapLike(scopeResult) ) {
							...
							ViewModel = CanMap.extend(scopeResult);
						}
					}
				...
				}, initialViewModelData, {makeDataBinding: makeDataBinding});
			}
			...
			var leakScope = {
				toLightContent: this.leakScope === true || this.leakScope === undefined,
				intoShadowContent: this.leakScope === true || this.leakScope === undefined
			};
...
module.exports = can23.Component = Component;
